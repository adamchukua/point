...
@section('title', config('app.name', 'Laravel') . ': Відгук на бронювання ' . $booking->hotel->name)
...
@section('content')
    <div class="container">
        ...
        <h1 class="profile--title">
            ...
            <a href="" class="link-unstyled">{{ $booking->hotel->name }}</a>
        </h1>

        <form action="/profile/bookings/{{ $booking->id }}/review/create" method="post">
            @csrf
            ...
            <div class="row">
                <div class="col-3">
                    ...
                    <input id="personnel_mark"
                           ...
                           min="0"
                           required
                           value="{{ old('personnel_mark') }}"
                           autocomplete="personnel_mark">
                ...
                <div class="col-3">
                    ...
                    <input id="comfort_mark"
                           ...
                           min="0"
                           required
                           value="{{ old('comfort_mark') }}"
                           autocomplete="comfort_mark">
                ...
                <div class="col-3">
                    ...
                    <input id="free_wifi_mark"
                           ...
                           min="0"
                           required
                           value="{{ old('free_wifi_mark') }}"
                           autocomplete="free_wifi_mark">
                ...
                <div class="col-3">
                    ...
                    <input id="amenities_mark"
                           ...
                           min="0"
                           required
                           value="{{ old('amenities_mark') }}"
                           autocomplete="amenities_mark">
                ...
                <div class="col-3">
                    ...
                    <input id="price_quality_mark"
                           ...
                           min="0"
                           required
                           value="{{ old('price_quality_mark') }}"
                           autocomplete="price_quality_mark">
                ...
                <div class="col-3">
                    ...
                    <input id="purity_mark"
                           ...
                           min="0"
                           required
                           value="{{ old('purity_mark') }}"
                           autocomplete="purity_mark">
                ...
                <div class="col-3">
                    ...
                    <input id="location_mark"
                           ...
                           min="0"
                           required
                           value="{{ old('location_mark') }}"
                           autocomplete="location_mark">
